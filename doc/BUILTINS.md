...
- Method: `diagnostics`
- Command: `actionlint`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/diagnostics/actionlint.lua))
...
- Method: `diagnostics`
- Command: `cspell`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/diagnostics/cspell.lua))
...
- Method: `diagnostics`
- Command: `mypy`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/diagnostics/mypy.lua))
...
- Method: `diagnostics`
- Command: `tidy`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/diagnostics/tidy.lua))
...
- Method: `diagnostics`
- Command: `vale`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/diagnostics/vale.lua))
...
- Command: `autopep8`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/autopep8.lua))
...
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/clang_format.lua))
...
- Method: `formatting`
- Command: `deno`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/deno_fmt.lua))
...
- Method: `formatting`
- Command: `emacs`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/emacs_scheme_mode.lua))
...
- Method: `formatting`
- Command: `emacs`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/emacs_vhdl_mode.lua))
...
- Method: `formatting`
- Command: `R`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/format_r.lua))
...
- Methods: `formatting, range_formatting`
- Command: `prettier`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/prettier.lua))
...
- Methods: `formatting, range_formatting`
- Command: `prettierd`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/prettierd.lua))
...
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/prettier_d_slim.lua))
...
- Methods: `formatting, range_formatting`
- Command: `pyink`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/pyink.lua))
...
- Method: `formatting`
- Command: `rescript`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/rescript.lua))
...
- Method: `formatting`
- Command: `R`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/styler.lua))
...
- Methods: `formatting, range_formatting`
- Command: `stylua`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/stylua.lua))
...
- Method: `formatting`
- Command: `uncrustify`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/uncrustify.lua))
...
- Methods: `formatting, range_formatting`
- Command: `yapf`
- Args: dynamically resolved (see [source](https://github.com/brain-fuel/null-ls.nvim/blob/main/lua/null-ls/builtins/formatting/yapf.lua))
